<template>
    <div style="background-color:#e7e0d8;">
        ...
        <!--banner-->
        <div class="gametopic_banner_box" style="position:relative;">
            ...
            <div class="topic_downbtn_box" style="top: 640px;">
                <a style="display: inline-block;" class="topic_downbox" :href="windowsDownloadUrl">
                ...
                <div style="margin: 10px auto 0;color: #fefefe;">
                    <p style="font-size: 32px">全网独家提速Origin平台  Apex英雄下载加速</p>
